...
**Budget App** is a Rails-built fully functional app that allows the user to:
...
```sh
  git clone https://github.com/Bellagirl-maker/budget_app.git
```
...
I would like to give credit to [ Gregoire Vella on Behance](https://www.behance.net/gregoirevella) for the design of this app and  [Microverse](https://bit.ly/MicroverseTN) for the opportunity to work on this project.
